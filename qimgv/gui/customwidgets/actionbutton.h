...
public:
    ...
    ActionButton(QString _actionName, const QString &_iconPath, QWidget *parent = nullptr);
    ActionButton(QString _actionName, const QString &_iconPath, int _size, QWidget *parent = nullptr);
